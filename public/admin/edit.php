...
function site_admin_render_settings_form(array $data): void
{
    $fields = [
        ...
        ['hero_eyebrow', 'Hero: надзаголовок (АН «Содействие»)', 'text'],
        ['hero_headline', 'Hero: заголовок на главной (H1)', 'text'],
        ['slogan_hero', 'Hero: подзаголовок', 'textarea'],
        ['hero_tab_buy', 'Hero: вкладка «Купить»', 'text'],
        ['hero_tab_sell', 'Hero: вкладка «Продать»', 'text'],
        ['hero_tab_rent_in', 'Hero: вкладка «Снять»', 'text'],
        ['hero_tab_rent_out', 'Hero: вкладка «Сдать»', 'text'],
        ['hero_tab_new', 'Hero: вкладка «Новостройки»', 'text'],
        ['hero_tab_abroad', 'Hero: вкладка «Зарубежная»', 'text'],
        ['hero_cta_find', 'Hero: кнопка «Найти»', 'text'],
        ['hero_cta_map', 'Hero: кнопка «На карте»', 'text'],
