...
/**
 * Логотип бренда: премиум PNG/WebP (полный lockup) или запасной SVG/PNG.
 *
...
if ($premiumSrc !== '') {
    ...
    echo '<img class="' . $imgClass . '" src="' . htmlspecialchars($premiumSrc, ENT_QUOTES, 'UTF-8') . '" width="300" height="82" alt="' . htmlspecialchars($logoAlt, ENT_QUOTES, 'UTF-8') . '" decoding="async">';
    return;
}
