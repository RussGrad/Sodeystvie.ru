 ...
 * @param string $linkClass CSS-класс на <a> (модификаторы --tg, --wa, --max)
...
function site_render_messenger_links(
    ...
    if ($whatsappUrl !== null) {
        site_render_messenger_link_item($linkClass, '--wa', $whatsappUrl, 'WhatsApp', $showLabels, 'whatsapp');
    }
...
/**
 * @param 'telegram'|'whatsapp'|'max' $type
 */
function site_render_messenger_link_item(
    ...
    $cellClass = 'messenger-links__cell';
    echo '<li class="' . $cellClass . '">';
